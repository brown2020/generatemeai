...
export const MODEL_REGISTRY = {
  "dall-e": {
    ...
    capabilities: { ...IMAGE_ONLY_CAPABILITIES, supportsNegativePrompt: false, maxImages: 4 },
    strategyKey: "dalle",
  },
  "stability-sd3-turbo": {
    id: 3,
    value: "stability-sd3-turbo",
    label: "Stability SD3.5 Turbo",
    type: "image",
    credits: {
  ...
  "flux-schnell": {
    ...
    capabilities: { ...NO_UPLOAD_CAPABILITIES, maxImages: 1 },
  ...
  "flux-kontext-pro": {
    ...
    label: "FLUX Kontext Pro (Fireworks)",
    type: "image",
    credits: {
      envKey: "NEXT_PUBLIC_CREDITS_PER_FLUX_KONTEXT_PRO",
      fallback: 4,
    },
    apiKey: { envKey: "FIREWORKS_API_KEY", formDataKey: "fireworksAPIKey" },
    capabilities: { ...IMAGE_ONLY_CAPABILITIES, supportsNegativePrompt: false, maxImages: 1 },
    strategyKey: "fireworksKontext",
  },
  "d-id": {
    id: 7,
    value: "d-id",

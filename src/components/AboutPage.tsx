...
export default function AboutPage() {
  ...
  return (
    <div className="flex flex-col h-full items-center px-6 py-12 justify-center w-full max-w-5xl mx-auto flex-1 gap-12 bg-gray-100">
      <div className="text-5xl font-bold text-center text-gray-800">About Generate.me</div>
      ...
      <div className="bg-white shadow-md p-8 rounded-lg">
        <div className="text-3xl font-semibold text-gray-800 mb-6">How to Use Generate.me</div>
      ...
      <div className="bg-white shadow-md p-8 rounded-lg w-full">
        <div className="text-3xl font-semibold text-gray-800 mb-6">Frequently Asked Questions</div>
...
const faqData = [
  {
    ...
    answer: 'Generate.me is a powerful AI-based platform that allows users to create images from text descriptions using a variety of cutting-edge AI models like DALL-E, Stable Diffusion, and others.',
  },
  {
    question: '2. How do I generate an image?',
    answer: 'Simply describe the image you want to create, select an AI model, choose an artistic style, and click "Generate". The AI will then produce an image based on your input.',
  },
  {
    question: '3. Can I edit the images I’ve generated?',
    answer: 'Yes! You can edit your prompt and regenerate an image using the same model, or try out different styles and AI models for new variations.',
  },
  {
    question: '4. What are tags and how do I use them?',
    answer: 'Tags help you organize your generated images. You can add custom tags to each image, making it easier to search and filter through your creations later.',
  },
  {
    question: '5. How can I share my images?',
    answer: 'Images can be shared by generating a shareable link or directly posting to your social media channels from within the platform.',
  },
  {
    question: '6. Can I download my images?',
    answer: 'Yes, you can download any image you create in high resolution directly to your device.',
  },
  {
    question: '7. Are there any limitations to the models?',
    answer: 'Each AI model has its own strengths and limitations. Some models may excel at realism while others are better at abstract or artistic styles. We recommend experimenting to find the best model for your needs.',
  },
  {
    question: '8. Is there a limit to the number of images I can generate?',
    answer: 'Currently, we offer a set number of free generations per user. Additional image generations may require a subscription or credits, depending on your usage.',
  },
  {
    question: '9. Can I use my own API keys instead of buying credits?',
    answer: 'Yes, you can use your own API keys! Just go to your profile, add your API keys, and select the option to use them instead of the platform’s default credit system.',
  },
];

  ...
  return (
    <>
      ...
      <p>
        ...
        credits it grants are shown at checkout. We may change, suspend, or
        discontinue a pack at any time. {companyName} decides which actions
        require credits.
      </p>
      <p>
        You agree to pay the price shown for the pack you purchase (“Fees”),
        plus applicable taxes. You authorize {companyName} or its payment
        processor to charge your payment method for that purchase only. By
        providing a payment method, you represent that you are authorized to use
        it. If the payment method cannot be verified, the purchase does not
        complete and no credits are granted. Refunds are not issued unless
        required by law.
      </p>
    </>
  );
  ...
  return (
    <>
      ...
      <p>
        ...
        published number of credits to your account. The purchase does not start
        a subscription and does not renew. Questions about a charge can be sent
        to {companyEmail}.
      </p>
      <p>
        New accounts receive a starting credit balance from {companyName}. Those
        starting credits are not a free trial that converts into a recurring
        charge. When they run out, you can buy another pack or use your own
        provider API keys.
      </p>
      <p>
        A password on a shared image is a casual gate for that link. It is not
        account security and it is not a secret credential.
      </p>
      <p>
        Payment information is processed by a third-party payment processor. You
        do not need to keep a card on file after a purchase.
      </p>
      <p>
      ...
      <p>
        ...
        notifications related to the Services and your account, purchases,
        available upgrades, billing and payment processing issues,
